 ...
 */
final class Version20220825142352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE structures ADD partenaires_id INT DEFAULT NULL, ADD ass_partenaires_id INT DEFAULT NULL');
